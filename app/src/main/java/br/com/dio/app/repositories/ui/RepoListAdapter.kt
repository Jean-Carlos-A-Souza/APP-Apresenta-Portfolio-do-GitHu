...
import br.com.dio.app.repositories.databinding.ItemReponBinding
...
class RepoListAdapter : ListAdapter<Repo, RepoListAdapter.ViewHolder>(DiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = ItemReponBinding.inflate(inflater, parent, false)
    ...
    inner class ViewHolder(
        private val binding: ItemReponBinding
    ) : RecyclerView.ViewHolder(binding.root) {

        fun bind(item: Repo) {
            binding.tvRepoName.text = item.name
            binding.tvRepoDescript.text = item.description
